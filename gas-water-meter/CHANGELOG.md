...
- **Statistics import metadata** — include `mean_type` in external statistics metadata to avoid deprecation warnings and compatibility issues with Home Assistant Core 2026.11.

### Changed

- **Integration version bump** — integration and add-on versions updated to `0.3.0`.
...
- **Build** — fixed architecture in dockerfile

## [0.2.7] - 2026-07-05

### Fixed

- **Build** — removed build.yaml
...
- **Migration for old statistics id** — added migration on startup for old component ids.

## [0.2.4] - 2026-06-03

### Fixed

- **Fixed statistics id** — added a trailing "reading_" to meet homeassistants requirements.

## [0.2.3] - 2026-06-03

### Fixed

- **Fixed services.yaml step validation** — simplified number selector step values to integers (1) to resolve Home Assistant parse errors
